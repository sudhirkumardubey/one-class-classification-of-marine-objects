...
# To prepare above mentioned dataset do:
# Folder ending '_train' will be used for training.
# run Copy.py to make folder '003_FathomNet_Dataset_Min_ImgCnt_Train'. It is our 2(a) case folder.                  
python3 Copy.py
