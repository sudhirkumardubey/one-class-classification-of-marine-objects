...
# run Crop_BoundingBox.py, it will prepare two folder, namely '004_FathomNet_Dataset_Cropped' and 
#                       '004_FathomNet_Dataset_Min_ImgCnt_Cropped_Train'. It is our 2(b) case folder.
python3 Crop_BoundingBox.py
