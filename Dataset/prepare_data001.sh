...
# To download images from FathomnetNet Api: (Run code in the given order only)
# Run DownloadData.py to download random concepts. It will create '001_FathomNet_Dataset' folder in present directory. The minimum number of images can be 1.
